...
namespace SMS_Blazor.Components.Pages.SMSRiskManagement;
...
public partial class Reports : ComponentBase
{
    ...
    public async Task ShowCreateReportDialog()
    {
        try
        {
            ...
            var result = await DialogService.OpenAsync<SMS_Blazor.Components.Pages.SMSRiskManagement.Components.ReportCreate>(
...
Updated By: {report.UpdatedBy ?? "N/A"}";
    ...
    public async Task OnEditReportAsync(Report report)
    {
        ...
        try
        {
            ...
            // Show edit dialog
            var result = await DialogService.OpenAsync<SMS_Blazor.Components.Pages.SMSRiskManagement.Components.ReportEdit>("Edit Report",
                new Dictionary<string, object>()
                {
                    { "ReportData", editData },
