...
cd C:\Projects\PDXSMS_V2\Scripts 
.\Import-HazardReportsToAPI_V2.ps1 -CsvFilePath "C:\Projects\PDXSMS_V2\Shared\VeociExtract_051226.csv" -ApiBaseUrl "http://localhost:5115" -ApiKey "sms-tODrESNx9XBCfSs5FaC9Y" -BatchSize 2