...
.\Import-HazardReportsToAPI_V2.ps1 -CsvFilePath "C:\Projects\PDXSMS_V2\Shared\VeociExtract_06.csv" -ApiBaseUrl "https://sms-test.portofportland.com" -ApiKey "SMS-DEV-12345-ABCDEF" -BatchSize 2
