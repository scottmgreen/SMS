...
/// </summary>
public class HazardStatusChangedEvent : BaseDomainEvent, IEventSource
{
    public override string EventType => SMS_Domain.Enums.EventType.HazardStatusChanged.Value;

    /// <summary>
    /// Display name for SPI configuration dropdowns
    /// </summary>
    public string EventSourceDisplayName => SMS_Domain.Enums.EventType.HazardStatusChanged;
    ...
    /// </summary>
    public string EventSourceDescription => "Provides hazard status transition signals for closure-time and workflow progression SPI metrics";

    /// <summary>
    /// Indicates this event is automatically generated by workflow state transitions
    /// </summary>
    ...
    public HazardStatusChangedEvent(
        ...
        DateTime? escalationDeadline = null) : base(id)
    {
