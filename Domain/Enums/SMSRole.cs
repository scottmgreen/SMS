...
public abstract class SMSRole : BaseEnum<SMSRole>
{
    protected SMSRole(string value, string name, string category, string description, int authorityLevel) : base(value, name) 
    { 
        Category = category;
    ...
    public static readonly SMSRole AccountableExecutive = new AccountableExecutiveRole();
    public static readonly SMSRole ResponsibleExecutive = new ResponsibleExecutiveRole();
    public static readonly SMSRole ResponsibleManager = new ResponsibleManagerRole();
    #endregion

    #region Management Roles
    public static readonly SMSRole SMSManager = new SMSManagerRole();
    public static readonly SMSRole SMSCoordinator = new SMSCoordinatorRole();
    #endregion

    #region Operational Roles
    public static readonly SMSRole SMSTeamMember = new SMSTeamMemberRole();
    public static readonly SMSRole SubjectMatterExpert = new SubjectMatterExpertRole();
    public static readonly SMSRole SafetyInvestigator = new SafetyInvestigatorRole();
    public static readonly SMSRole SafetyAnalyst = new SafetyAnalystRole();
    #endregion

    #region Committee Roles
    public static readonly SMSRole CommitteeChair = new CommitteeChairRole();
    public static readonly SMSRole CommitteeMember = new CommitteeMemberRole();
    public static readonly SMSRole CommitteeFacilitator = new CommitteeFacilitatorRole();
    ...
    private sealed class AccountableExecutiveRole : SMSRole
    {
    ...
    private sealed class ResponsibleExecutiveRole : SMSRole
    {
    ...
    private sealed class ResponsibleManagerRole : SMSRole
    {
    ...
    private sealed class SMSManagerRole : SMSRole
    {
    ...
    private sealed class SMSCoordinatorRole : SMSRole
    {
    ...
    private sealed class SMSTeamMemberRole : SMSRole
    {
    ...
    private sealed class SubjectMatterExpertRole : SMSRole
    {
    ...
    private sealed class SafetyInvestigatorRole : SMSRole
    {
    ...
    private sealed class SafetyAnalystRole : SMSRole
    {
    ...
    private sealed class CommitteeChairRole : SMSRole
    {
    ...
    private sealed class CommitteeMemberRole : SMSRole
    {
    ...
    private sealed class CommitteeFacilitatorRole : SMSRole
    {
    ...
    public static IEnumerable<SMSRole> GetRolesByCategory(string category)
    {
    ...
    public static IEnumerable<SMSRole> GetAllValues()
    {
        return typeof(SMSRole)
            .GetFields(BindingFlags.Public | BindingFlags.Static | BindingFlags.DeclaredOnly)
            .Where(f => f.FieldType == typeof(SMSRole))
            .Select(f => (SMSRole)f.GetValue(null)!)
