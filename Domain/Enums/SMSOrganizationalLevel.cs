...
{
    protected SMSOrganizationalLevel(string value, string name, string category, string description, int authorityLevel) : base(value, name)
    {
        Category = category;
    ...
    public static readonly SMSOrganizationalLevel ResponsibleManager = new ResponsibleManagerLevel();
    #endregion

    #region Management Roles
    public static readonly SMSOrganizationalLevel SMSManager = new SMSManagerLevel();
    public static readonly SMSOrganizationalLevel SMSCoordinator = new SMSCoordinatorLevel();
    #endregion

    #region Operational Roles
    public static readonly SMSOrganizationalLevel SMSTeamMember = new SMSTeamMemberLevel();
    ...
    private sealed class AccountableExecutiveLevel : SMSOrganizationalLevel
    {
        public AccountableExecutiveLevel() : base("ACCOUNTABLE_EXECUTIVE", "Accountable Executive", "Executive",
    ...
    {
        public ResponsibleExecutiveLevel() : base("RESPONSIBLE_EXECUTIVE", "Responsible Executive", "Executive",
    ...
    private sealed class SMSManagerLevel : SMSOrganizationalLevel
    {
        public SMSManagerLevel() : base("SMS_MANAGER", "SMS Manager", "Management",
    ...
    private sealed class SMSTeamMemberLevel : SMSOrganizationalLevel
    {
        public SMSTeamMemberLevel() : base("SMS_TEAM_MEMBER", "SMS Team Member", "Operational",
    ...
    //private sealed class CoreVotingMemberRole : SMSOrganizationalUserRole
    //{
    ...
    //private sealed class AirlineRepresentativeRole : SMSOrganizationalUserRole
    //{
    ...
    //private sealed class GroundHandlerRepresentativeRole : SMSOrganizationalUserRole
    //{
    ...
    //private sealed class TenantRepresentativeRole : SMSOrganizationalUserRole
    //{
    ...
    //private sealed class ContractorRepresentativeRole : SMSOrganizationalUserRole
    //{
    ...
    //private sealed class RegulatoryRepresentativeRole : SMSOrganizationalUserRole
    //{
    ...
    //private sealed class ExternalConsultantRole : SMSOrganizationalUserRole
    //{
    ...
    public static IEnumerable<SMSOrganizationalLevel> GetLevelsByCategory(string category)
    {
    ...
    public static IEnumerable<SMSOrganizationalLevel> GetAllValues()
    {
        return typeof(SMSOrganizationalLevel)
