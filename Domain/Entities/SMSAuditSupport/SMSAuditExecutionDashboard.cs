...
public class SMSAuditExecutionDashboard
{
    ...
    /// <summary>
    /// Total number of audits (calculated property for convenience)
    /// </summary>
    public int TotalAudits => TotalAuditsScheduled;
    ...
    /// <summary>
    /// Completed audits (alias for consistency)
    /// </summary>
    public int CompletedAudits => AuditsCompleted;
    ...
    /// <summary>
    /// Overdue audits (alias for consistency)
    /// </summary>
    public int OverdueAudits => AuditsOverdue;
    ...
    /// <summary>
    /// Average audit duration (alias for decimal compatibility)
    /// </summary>
    public decimal AverageAuditDuration => (decimal)AverageAuditDurationHours;

    /// <summary>
    /// Finding closure rate as a percentage
    /// </summary>
    public decimal FindingClosureRate => TotalFindings > 0 ? (decimal)FindingsResolved / TotalFindings * 100 : 0;
