...
//     Description: SMS interview entity representing interview for investigation and data collection.
...
/// <summary>
/// Interview entity for managing investigation interviews and witness statements
/// </summary>
public class Interview : BaseAuditableEntity
{
    ...
    public static Result<Interview> CreateForInvestigation(string investigationCode, string personInterviewed, string investigatorCode, InterviewType? type = null)
    {
        ...
        {
            return Result.Failure<Interview>(DomainErrors.InterviewError.InvestigationCodeRequired);
        }

        if (string.IsNullOrWhiteSpace(personInterviewed))
        {
            return Result.Failure<Interview>(DomainErrors.InterviewError.PersonInterviewedRequired);
        }

        if (string.IsNullOrWhiteSpace(investigatorCode))
        {
            return Result.Failure<Interview>(DomainErrors.InterviewError.InvestigatorRequired);
        }
        ...
        string investigatorCode, string? personInterviewedNotes = null, string? investigatorNotes = null)
    {
        ...
        {
            return Result.Failure<Interview>(DomainErrors.InterviewError.CodeRequired);
        }
    ...
    public Result<bool> CancelInterview(string reason)
    {
        ...
        {
            return Result.Failure<bool>(DomainErrors.InterviewError.CancellationReasonRequired);
        }
