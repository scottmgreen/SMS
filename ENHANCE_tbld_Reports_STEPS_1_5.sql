-- **************************************************
-- ENHANCE tbld_Reports TABLE FOR STEPS 1-5 INTEGRATION
-- Complete Reports table enhancement with proper ReportValidation integration
-- **************************************************
USE [PDXSMS_V2]
GO
...
PRINT 'Adding missing enhanced fields for comprehensive report management';
PRINT '***************************************************';

-- **************************************************
-- UPDATE tbld_Reports TABLE - Add All Enhanced Fields
-- **************************************************
...
-- Add Report Validation Integration Fields (these are the fields mentioned in your context)
...
-- Add Investigation Integration Fields
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'tbld_Reports' AND COLUMN_NAME = 'fldb_RequiresInvestigation')
BEGIN
    ALTER TABLE [dbo].[tbld_Reports]
    ADD [fldb_RequiresInvestigation] [bit] NULL DEFAULT 0;
END

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'tbld_Reports' AND COLUMN_NAME = 'fldv_InvestigationStatus')
BEGIN
    ALTER TABLE [dbo].[tbld_Reports]
    ADD [fldv_InvestigationStatus] [nvarchar](50) NULL; -- Not Required, Assigned, In Progress, Completed
END

IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'tbld_Reports' AND COLUMN_NAME = 'fldv_AssignedInvestigator')
BEGIN
    ALTER TABLE [dbo].[tbld_Reports]
    ADD [fldv_AssignedInvestigator] [nvarchar](50) NULL;
END
...
-- **************************************************
-- UPDATE pr_Report_GetById STORED PROCEDURE
-- **************************************************
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Main Report Query with Complete Enhanced Data
        SELECT 
            -- Core Fields
            [fldi_ID],
            [fldv_Code],
            ...
            [fldv_InvestigationStatus],
            [fldv_AssignedInvestigator],
...
-- **************************************************
-- UPDATE pr_Report_Update STORED PROCEDURE
-- **************************************************
...
PRINT 'Enhanced Reports Table Structure:';
SELECT 
    COLUMN_NAME,
    DATA_TYPE,
    IS_NULLABLE,
...
PRINT '? Investigation Integration: Investigation status and assignment tracking';
...
PRINT '? pr_Report_GetById: Complete data retrieval with all validation fields';
PRINT '? pr_Report_Update: Enhanced parameter support for all validation fields';
PRINT '';
...
PRINT '- Optimized for ReportValidation entity requirements';
PRINT '***************************************************';
