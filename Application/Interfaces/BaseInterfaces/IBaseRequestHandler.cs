//-----------------------------------------------------------------------
// <copyright file="IBaseRequestHandler.cs" company="SMS Safety Management System">
...
//public interface IBaseRequestHandler<in TRequest> where TRequest : class, IRequest
//{
//    Task HandleAsync(TRequest request, CancellationToken cancellation = default);

//}
public interface IBaseRequestHandler<in TRequest, TResponse> where TRequest : class, IRequest<TResponse>
{
