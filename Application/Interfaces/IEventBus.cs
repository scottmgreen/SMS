//-----------------------------------------------------------------------
// <copyright file="IEventBus.cs" company="SMS Safety Management System">
...
public interface IEventBus
{
    ...
    /// <typeparam name="THandler">Handler type implementing IGenericEventHandler</typeparam>
    void Subscribe<T, THandler>() where T : IBaseDomainEvent where THandler : class, IGenericEventHandler<T>;
    ...
    /// <typeparam name="THandler">Handler type implementing IGenericEventHandler</typeparam>
    void SubscribeUI<T, THandler>() where T : IUIEvent where THandler : class, IGenericEventHandler<T>;
    ...
    /// <typeparam name="THandler">Handler type implementing IGenericEventHandler</typeparam>
    void SubscribeIntegration<T, THandler>() where T : IIntegrationEvent where THandler : class, IGenericEventHandler<T>;
