...
// Import the HazardCreatedEvent with full namespace to avoid conflicts
...
/// </summary>
public class SPIAutomationEventHandler : BaseDomainEventHandler<SMS_Domain.Events.Hazard.HazardCreatedEvent>
{
