//-----------------------------------------------------------------------
// <copyright file="SMSSystemRepository.cs" company="SMS Safety Management System">
...
public sealed class SMSSystemRepository : BaseRepository<SMSSystemRepository, AuditLogEntry>
{
    private readonly ILogger<SMSSystemRepository> _logger;
    private readonly string _logheader;
    private readonly string _connectionString;
    private readonly IConfiguration _configuration;
    private readonly IFeatureManager _featureManager;

    public SMSSystemRepository(ILogger<SMSSystemRepository> logger, ILogSupport logsupport, IConfiguration configuration, IFeatureManager featureManager) : base(logger, logsupport, configuration)
    {
